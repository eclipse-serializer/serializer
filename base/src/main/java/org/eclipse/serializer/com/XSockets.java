...
public final class XSockets
{
	...
	public static ServerSocketChannel openServerSocketChannel(final InetSocketAddress address)
		throws ComException
	{
		try
		{
	...
	public static SocketChannel acceptSocketChannel(final ServerSocketChannel serverSocketChannel)
		throws ComException
	{
		try
		{
	...
	public static void closeChannel(final NetworkChannel channel) throws ComException
	{
		try
		{
			channel.close();
	...
	public static ByteBuffer readIntoBufferKnownLength(
	...
	{
		void execute(SocketChannel channel, ByteBuffer buffer) throws ComException; // funny "public"
	}
