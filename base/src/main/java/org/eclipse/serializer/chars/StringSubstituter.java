...
public final class StringSubstituter implements StringStamper
{
	...
	public static StringSubstituter New()
	{
	...
	public synchronized String substitute(final String item)
	{
		if(item == null)
		{
			return null;
	...
	public synchronized String substitute(final char[] chars, final int offset, final int length)
	{
	...
	public synchronized StringSubstituter iterate(final Consumer<? super String> procedure)
	{
	...
	public synchronized String remove(final String item)
	{
		final int hash = item.hashCode();
