...
public final class MemoryCharConversionIntegers
{
	...
	public static long put_byte(final byte value, final long address)
	{
	...
	public static long put_short(final short value, final long address)
	{
		// pure algorithm method intentionally without array bounds check. Use VarString etc. for that.
		if(value < 0)
		{
	...
	public static long put_int(final int value, final long address)
	{
		// pure algorithm method intentionally without array bounds check. Use VarString etc. for that.
		if(value < 0)
		{
	...
	public static long put_long(final long value, final long address)
	{
		// pure algorithm method intentionally without array bounds check. Use VarString etc. for that.
		if(value < 0)
		{
	...
	public static long put_longPositive(final long value, final long address)
	{
		if(value >= V001G)
		{
			if(value >= V001Z
