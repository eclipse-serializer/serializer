...
import org.eclipse.serializer.collections.interfaces._intCollecting;
...
import org.eclipse.serializer.functional._intFunction;
import org.eclipse.serializer.functional._intIndexProcedure;
import org.eclipse.serializer.functional._intPredicate;
...
public final class _intList implements _intCollecting, Composition
{
	...
	{
		throw new org.eclipse.serializer.meta.NotImplementedYetError(); // FIXME _intList#replaceAll()
	}
	...
	public boolean nullAdd()
	{
		...
		this.data[this.size] = 0;  // It has to be here. For example, operation 'remove' changes the removed value to Integer.MIN_VALUE.
		this.size++;
		return true;
	}
	...
	{
		return this.insertAll(index, elements, offset, length);
	}

	public int inputAll(final int index, final _intList elements)
	{
		return this.insertAll(index, elements);
	}
	...
	{
		throw new org.eclipse.serializer.meta.NotImplementedYetError(); // FIXME _intList#removeAll()
